...
export default function Topbar() {
    return (
        <div className='flex justify-start items-center gap-4 pb-2 mb-2 border-b border-gray-300  '>
            ...
            <button className='hover:scale-105 transition-all ml-auto p-2 text-sm bg-gradient-to-r from-indigo-500 text-white to-purple-500 rounded-xl cursor-pointer font-bold '>My Favorite Quotes</button>
